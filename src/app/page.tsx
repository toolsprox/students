  ...
  return (
    <main className="min-h-screen bg-[#FDFBF7] text-[#0F0F0F] relative overflow-hidden font-sans pt-32 pb-16">
      ...
      <section className="relative min-h-[90vh] flex flex-col md:flex-row items-center justify-between gap-6 pt-32 pb-16 px-4 md:px-8 max-w-7xl mx-auto z-10">
        ...
        >
          ...
          <div className="flex gap-6 mt-4">
            <PulseCTA href="https://masakali.co.uk/bookings/?utm_source=google&utm_medium=cpc&utm_campaign=family-celebrations&utm_content=search" target="_blank" rel="noopener noreferrer" className="group relative bg-[#0F0F0F] text-white font-bold px-10 py-5 rounded-2xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_40px_rgba(124,255,1,0.3)] transition-all">
      ...
      <section className="py-24 max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <Link href="https://masakali.co.uk/bookings/?utm_source=google&utm_medium=cpc&utm_campaign=family-celebrations&utm_content=search" target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-[#0F0F0F] text-white font-bold text-lg px-12 py-5 rounded-2xl hover:bg-[#7CFF01] hover:text-black transition-all shadow-xl group">
